      ...
      <body>
        <div id="wd-lab1">
          ...
          <div id="wd-h-tag">
            ...
            heading tags for different sizes: h1, h2, h3, h4, h5, and h6. Tag h1
          ...
          <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
              <p>French Toast:</p>
              <li>
                Dip each bread slice into the egg mixture, dredging on both
                sides.
              </li>
              <li>
                Place bread on hot greased griddle or large skillet. Cook for a
                few minutes on each side, until golden.
              </li>
              <li>Service with side of syrup and fruit</li>
            </ol>
          ...
          <div id="links">
            ...
            <br />
            <a
              href="https://github.com/miguelit07/kambas-next-js-cs4550-fa25"
              id="wd-github"
            >
              Github link
            </a>
