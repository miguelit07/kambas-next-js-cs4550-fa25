...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/miguelit07/kambas-next-js-cs4550-fa25">
          My GitHub
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://github.com/miguelit07/kambaz-node-server-app">
          New Server Repository Link
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://kambaz-node-server-app-s5sn.onrender.com">
          Server Root Link
        </NavLink>
      </NavItem>
    </Nav>
